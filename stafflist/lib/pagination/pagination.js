...
var Pagination = (function () {
    function Pagination(options) {
        ...
        this.paginationContainer = jQuery(options.container);
    ...
    Pagination.prototype.make = function (itemsCount, itemsOnPage, defaultPageNumber) {
        ...
        var $innerContainer = jQuery(document.createElement("div"));
    ...
    Pagination.prototype.updateCurrentPage = function (newPageNumber, callPageClickCallback) {
        ...
        jQuery(this.goToPageInput).val(newPageNumber);
        jQuery(this.sliderDiv).slider("value", newPageNumber);
        jQuery(this.sliderTipDiv).text(newPageNumber);
    ...
    Pagination.prototype.createPageElement = function (label, pageNumber) {
        ...
        var $pageLink = jQuery(pageLink);
        $pageLink
            .html(label)
            .attr("data-page-number", pageNumber)
            .click(this.onPageClick.bind(this));
        var pageClickUrl = this.options.pageClickUrl;
        var hrefUrl = pageClickUrl
            ? this.createPageClickUrl(pageNumber)
            : "#pagination-container"; // $("#sl-stafflist-body").parents('.et_pb_row').get(0).scrollIntoView();
    ...
    Pagination.prototype.recreatePageElements = function (pageNumber) {
        var _this = this;
        var $paginationUl = jQuery(this.paginationUl);
    ...
    Pagination.prototype.onPageClick = function (event) {
        var pageValue = jQuery(event.target).data("page-number");
    ...
    Pagination.prototype.createPageClickUrl = function (pageNumber) {
        ...
        switch (typeof pageClickUrl) {
            ...
            default:
                return window.scrollTo(500, 0);//"#pagination-container" || topFunction('pagination-container');
        }
    };
